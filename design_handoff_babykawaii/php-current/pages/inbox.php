...
.conv-avatar { width:36px; height:36px; border-radius:50%; background:linear-gradient(135deg,#E8869B,#8A6DB0); color:#fff; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:0.85rem; flex-shrink:0; }
...
.msg-row.outbound .msg-bubble { background:linear-gradient(135deg,#E8869B,#d4629e); color:#fff; border-bottom-right-radius:3px; }
...
.msg-avatar { width:26px; height:26px; border-radius:50%; background:linear-gradient(135deg,#E8869B,#8A6DB0); color:#fff; display:flex; align-items:center; justify-content:center; font-size:0.66rem; font-weight:700; flex-shrink:0; overflow:hidden; }
...
.btn-send { background:linear-gradient(135deg,#E8869B,#d4629e); color:#fff; border:none; border-radius:10px; padding:8px 16px; cursor:pointer; font-family:inherit; font-weight:600; white-space:nowrap; transition:opacity .15s; }
...
function renderMsg(m) {
    ...
    const adminAv = `<div class="msg-avatar" style="background:linear-gradient(135deg,#E8869B,#D26A82);">A</div>`;
...
function sendReply() {
    ...
    el.insertAdjacentHTML('beforeend', `<div class="msg-row outbound" id="${tmpId}">
        ...
        <div class="msg-avatar" style="background:linear-gradient(135deg,#E8869B,#D26A82);">A</div>
    </div>`);
    el.scrollTop = el.scrollHeight;
