                ...
                <div class="product-info">
                    <div class="d-flex justify-content-between align-items-start mb-1">
                        <div class="d-flex gap-1 align-items-center flex-wrap">
                            ...
                            <span style="background:linear-gradient(135deg,#8A6DB0,#74589B);color:#fff;font-size:0.62rem;font-weight:700;padding:2px 7px;border-radius:20px;">🎁 เซต</span>
                            <?php endif; ?>
                        </div>
                        <?php
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div>
                                        ...
                                        <div style="font-size:0.75rem;color:var(--text-muted);">
                                            ...
                                            <span style="background:linear-gradient(135deg,#8A6DB0,#74589B);color:#fff;font-size:0.62rem;padding:1px 6px;border-radius:20px;margin-left:4px;">🎁 เซต</span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
