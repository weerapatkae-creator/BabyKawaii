    ...
    <div class="card-body py-3">
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div id="bundleTypeBadge" class="ms-auto <?= $currentType==='bundle'?'':'d-none' ?>">
                <span style="background:linear-gradient(135deg,#E8869B,#8A6DB0);color:#fff;padding:5px 14px;border-radius:20px;font-size:0.82rem;font-weight:600;">🎁 เซตประหยัด</span>
            </div>
        </div>
    </div>
</div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <a class="dropdown-item" href="#" onclick="genSKU('set');return false;">
                                    <i class="fas fa-boxes-stacked me-2" style="color:#8A6DB0;"></i>
    ...
    <div id="singleStockSection" class="card <?= $currentType==='bundle'?'d-none':'' ?>">
        ...
        <div class="card-body">
                ...
                <table class="table table-bordered" id="stockTable" style="font-size:0.85rem;">
                    <thead>
                        <tr>
                            ...
                            <th style="background:var(--bg);min-width:130px;color:#8A6DB0;">รหัสสี (SKU)</th>
                    ...
                    <tbody id="stockTbody">
                        ...
                        <tr class="stock-row">
                            ...
                            <td>
                                <div class="color-sku-badge" style="font-size:0.72rem;font-weight:700;color:#8A6DB0;font-family:monospace;background:var(--lavender);border-radius:6px;padding:4px 8px;white-space:nowrap;">
            ...
            <div class="d-flex align-items-center gap-3 mt-2">
                ...
                <div id="variantCountBadge" style="font-size:0.75rem;background:var(--lavender);color:#8A6DB0;border-radius:12px;padding:2px 10px;font-weight:600;"></div>
            </div>
        </div>
    </div>
            ...
            <div id="bundleSummaryBar" class="px-4 py-3 border-top <?= empty($bundleItems)?'d-none':'' ?>"
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <span id="bundleSavings" style="font-size:1.1rem;font-weight:700;color:#3AA088;">฿0</span>
                    </div>
            ...
            <div id="singleProfitPanel">
                <div class="row g-2 text-center">
                    ...
                    <div class="col-12 border-top pt-2">
                        ...
                        <div id="previewProfit" style="font-size:1.5rem;font-weight:800;color:#3AA088;">฿0</div>
            ...
            <div id="bundleProfitPanel" class="<?= $currentType!=='bundle'?'d-none':'' ?>">
                <div class="row g-2 text-center">
                    ...
                    <div class="col-6 border-top pt-2">
                        ...
                        <div id="bpProfit" style="font-size:1.2rem;font-weight:800;color:#3AA088;">฿0</div>
                    </div>
                    <div class="col-12 pt-1">
                        <div style="font-size:0.78rem;color:var(--text-muted);">ลูกค้าประหยัด</div>
                        <div id="bpSavings" style="font-size:1.1rem;font-weight:700;color:#8A6DB0;">฿0 (0%)</div>
                    </div>
                </div>
            </div>
        </div>
...
function updateVariantSKUs() {
    ...
    if (preview) {
        if (baseSku) {
            preview.innerHTML = `<i class="fas fa-tag" style="color:#8A6DB0;"></i> <code style="color:#8A6DB0;">${baseSku}</code> → รหัสตัวอย่าง: <code>${baseSku}-W-NB</code>`;
        } else {
...
function updateProfit() {
    ...
    document.getElementById('previewProfit').style.color = profit >= 0 ? '#3AA088' : '#FF5757';
}
...
function updateBundleSummary() {
    ...
    document.getElementById('bpProfit').style.color   = profit >= 0 ? '#3AA088' : '#FF5757';
