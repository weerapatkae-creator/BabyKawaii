...
.picker-head {
    background: linear-gradient(135deg, #FF85A2, #9B72CF);
...
.media-item:hover { border-color: #FF85A2; transform: translateY(-1px); }
.media-item.selected { border-color: #9B72CF; }
.media-item.selected::after {
    content: '✓'; position: absolute; top: 4px; right: 4px;
    background: #9B72CF; color: #fff; border-radius: 50%;
...
.selected-count { font-size: 0.82rem; color: #9B72CF; font-weight: 600; }
...
<?php if (empty($items)): ?>
    <div class="empty-state" style="grid-column:1/-1;">
        ...
        <a href="<?= SITE_URL ?>/pages/media.php" target="_blank" style="color:#FF85A2;">อัปโหลดสื่อก่อน</a>
    </div>
<?php endif; ?>
