...
<div class="container-fluid fade-in">
                ...
                <tr class="<?= !$u['is_active'] ? 'opacity-50' : '' ?>">
                    <td>
                        <div class="d-flex align-items-center gap-2">
                            <div class="user-avatar-circle" style="background:<?= $u['role']==='superadmin'?'linear-gradient(135deg,#9B72CF,#7B52AF)':($u['role']==='admin'?'linear-gradient(135deg,#FF85A2,#E8547A)':'linear-gradient(135deg,#3DD98F,#20B870)') ?>">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="perm-block" style="border-left:4px solid #9B72CF;padding:12px 16px;background:var(--lavender);border-radius:var(--radius-sm);">
                        <div style="font-weight:700;color:#9B72CF;margin-bottom:8px;">👑 ผู้ดูแลระบบ (Superadmin)</div>
                ...
                <div class="col-md-4">
                    <div class="perm-block" style="border-left:4px solid #FF85A2;padding:12px 16px;background:var(--pink-light);border-radius:var(--radius-sm);">
                ...
                <div class="col-md-4">
                    <div class="perm-block" style="border-left:4px solid #3DD98F;padding:12px 16px;background:var(--mint);border-radius:var(--radius-sm);">
...
<div class="modal fade" id="addUserModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:var(--radius);border:none;">
            <div class="modal-header" style="background:linear-gradient(135deg,#FF85A2,#9B72CF);color:#fff;border-radius:var(--radius) var(--radius) 0 0;">
