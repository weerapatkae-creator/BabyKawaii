...
$catColors = ['#FF85A2','#9B72CF','#3DD98F','#FFD166','#4FC3F7','#FF9A3C','#E4405F','#8B5CF6'];
$extraJs = "
...
new Chart(tCtx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            borderColor: '#FF85A2', backgroundColor: 'rgba(255,133,162,0.1)',
