...
<div class="container-fluid fade-in">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-3">
            <div class="card p-3 text-center">
                <div style="font-size:1.6rem;font-weight:700;color:#9B72CF;"><?= formatPrice($stats['revenue']) ?></div>
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    <?php foreach ($customers as $c):
                        ...
                        $tagColors = ['VIP'=>'#9B72CF','ลูกค้าประจำ'=>'#FF85A2','ออเดอร์ใหม่'=>'#27ae60','ต้องติดตาม'=>'#e67e22'];
                    ?>
                    <tr>
                        <td>
